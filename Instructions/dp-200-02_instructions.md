...
1. Azure portal の「**awsastudxx - コンテナー**」画面で、リストから「**images**」項目をクリックします。
...
1. 「**BLOB のアップロード**」画面を閉じ、「**images**」画面を閉じます。
...
1. Data Lake Gen 2 ストレージ アカウントのdata コンテナーにデータ ファイルをアップロードする。

### タスク 1: Storage Explorer をインストールする。

1. Azure portal の「**awdlsstudxx - コンテナー**」画面で、リストから「**data**」項目をクリックします。
...
1. 「**BLOB コンテナー**」の下で、矢印をクリックして展開し、**log** ファイル システムを表示します。**log** ファイル システムをクリックします。
...
1. 「**BLOB コンテナー**」の下で矢印をクリックして展開し、**data**ファイル システムを表示します。**data**ファイル システムをクリックします。
