...
3. **awcdbstudxx** 画面で、**+ コンテナーの追加** をクリックします。これにより、**awcdbstudxx | データ エクスプローラー** スクリーンを開きます。

4. **New Container** をクリックして、次の設定で「Clothing」という名前のコンテナーを含む製品データベースを作成します。
...
1. 「**awcdbstudcto - データ エクスプローラー**」  画面で、データ エクスプローラー ツールバーの 「New Container」 ボタンの反対側で、**Full Screen** アイコンをクリックします。"Open Fill Screen" ダイアログ ボックスで、**Open** をクリックします。Microsoft Edge で新しいタブが開きます。

2. **SQLAPI** ペインで、更新アイコンをクリックし、**Products** を展開し、**Clothing** をクリックして **Items** をクリックします。 

3. ドキュメント ペインで、**New Item** のアイコンをクリックします。新しいドキュメントが表示され、サンプル JSON が表示されます。
...
5. ドキュメント タブに JSON を追加したら、**Save** をクリックします。

6. ドキュメント ペインで、**New Item** のアイコンをクリックします。
...
7. ドキュメント タブに JSON を追加したら、**Save** をクリックします。
...
1. 開かれた Microsoft Edgeブラウザーのデータ エクスプローラーで、**Items** スクリーンで、画面の上にある **「New SQL Query」** ボタンをクリックします。

    > **注**: Query 1 タブが表示され、クエリ **SELECT * FROM c** が表示されます。
...
4. 既存のクエリ ウィンドウで、前のクエリを置き換えて、productId の JSON ファイルに id、manufacture、description を返すクエリを記述します。 
...
2. 新規ストアド プロシージャ画面で、**Stored Procedure Id** テキスト ボックスに **createMyDocument** と入力します。
...
4. 新規ストアド プロシージャ 画面で、**Save** をクリックします。

5. 新規ストアド プロシージャ画面で、**Execute**」 をクリックします。
...
1. Azure portal で Cosmos DB リソース **awcdbstudxx** ウィンドウに移動し、ブレードの **設定** で **「データをグローバルにレプリケートする」** をクリックします。
...
1. 「**awcdbstudxx - データをグローバルにレプリケートする**」 ウィンドウで、「**手動フェールオーバー**」 をクリックします。
