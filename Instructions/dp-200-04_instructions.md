...
1. [**クエリの実行**] アイコンをクリックします。次の結果が返されます
...
1. コレクション名に「**WebCustomers**」と入力し、 **Enter** を押します。
...
1. 次に、**BasicOperations** メソッドに戻り、そのメソッドの最後に次の値を追加します。
...
1. 次のコードをコピーして **BasicOperations** メソッドの最後に貼り付けます。
